...
return {
  ...
  opts = {
    ...
    sort_function = function(a, b) -- uses a custom function for sorting files and directories in the tree
    ...
    source_selector = {
      ...
      padding = 0, -- can be int or table. E.g: padding = { left = 2, right = 0 },
